...
<div style="padding-top:20px;padding-left:20px; width:1250px;'">
    	...
    	<div class="input" style="margin-top:20px;">
    		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  				<legend style="font-size:14px;font-weight:300;">入库表单填写</legend>
			</fieldset>
			...
			<form class="layui-form" action="" style="float:left; padding-left:30px; padding-top:50px; font-size:14px;font-weight:300;">
				 ...
				 <div class="layui-form-item">
				    <label class="layui-form-label" style="font-size:14px;font-weight:300;">入库时间:</label>
				     <div class="layui-input-inline">
				      <input id="time" type="text" autocomplete="off" placeholder="年-月-日" class="layui-input">
				    </div>
				</div>
				<div class="layui-form-item">
				    <label class="layui-form-label" style="font-size:14px;font-weight:300;">入库人员:</label>
				     <div class="layui-input-inline">
			...
			<button id="out" onclick="out()" style="float:right; margin-right:80px; margin-top:280px;" type="button" class="layui-btn layui-btn-normal">提交入库</button>
			</div>
