...
<div style="padding-top:20px;padding-left:20px; width:1250px;'">
    	...
    	<div class="input">
    		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  				<legend style="font-size:16px;">用户留言</legend>
			</fieldset>
			<div id="info"></div>
    	</div>
   	</div>
		...
		success: function(result){
			...
			if(result.length > 0){
		    	$.each(result, function(v, o){
		    		...
		    		str += "<div style='padding-left:30px' class='layui-field-box'>"+o.message+"";
		    		str += "<span style='padding-left:30px' class='layui-field-box'>——"+o.username+"</span></div></fieldset>";
		    	});
		    	$("#info").html(str);
			}
		}
